...
<head>
    ...
    <title>Trop de requêtes — SoukJannah</title>
...
<body>
    ...
    <h1 class="title">Trop de tentatives</h1>
    <p class="subtitle">
        Pour des raisons de sécurité, le nombre de connexions ou d&apos;actions depuis votre adresse a été temporairement limité.
        Patientez environ une minute, puis réessayez.
    </p>

    <a href="/" class="btn">Retour à l&apos;accueil</a><br>
    <a href="javascript:history.back()" class="btn-secondary">← Page précédente</a>
</body>
</html>
